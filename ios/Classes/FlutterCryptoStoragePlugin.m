#import "FlutterCryptoStoragePlugin.h"

static NSString *const KEYCHAIN_SERVICE = @"flutter_crypto_storage_service";
static NSString *const CHANNEL_NAME = @"plugins.jp.moneytree.security.crypto.storage/flutter_crypto_storage";

static NSString *const InvalidParameters = @"Invalid parameter's type";

@interface FlutterCryptoStoragePlugin()

@property (strong, nonatomic) NSDictionary *query;

@end

@implementation FlutterCryptoStoragePlugin
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    FlutterCryptoStoragePlugin* instance = [[FlutterCryptoStoragePlugin alloc] init];
